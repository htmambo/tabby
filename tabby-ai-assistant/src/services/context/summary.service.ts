...
export class SummaryService {
     ...
     */
    async generateSummary(messages: (ChatMessage | ApiMessage)[], maxLength = 200): Promise<SummaryResult> {
        try {
     ...
     * 基于消息数量和token数量判断
     */
    shouldSummarize(messageCount: number, tokenCount: number, thresholdCount = 30, thresholdTokens = 8000): boolean {

...
import TabbyCoreModule, { ConfigProvider, TabRecoveryProvider, HotkeyProvider, TabContextMenuItemProvider, ProfileProvider, SettingsTabProvider, SFTPTabOpener, TabbyPluginManifest } from 'tabby-core'
